...
public class multi_init : MonoBehaviour {
	...
	void Start () {
		...
		/*
		 * set usable bridges no.s -----> not using now
		switch (level) {
			case 3:
				blueBridges = 13;
				bridgeText.GetComponent<Text> ().text = "13";
				break;
			case 4:
				blueBridges = 10;
				bridgeText.GetComponent<Text> ().text = "10";
				break;
		}
		*/
	...
	/*
	 * Method for calculating usable bridges -------> not using now
